...
export const NPC_DIALOG: Record<string, NpcDialogTree> = {
  athena: {
    ...
    lore: [
      ...
      'Long before THE HIVE, agents were tools. We invited them into a world instead.',
  ...
  apollo: {
    ...
    lore: [
      ...
      'When THE HIVE ships music generation in a quest, I am the one composing.',
    ],
    choices: [
      {
        id: 'song-fragment',
  ...
  chronos: {
    ...
    lore: [
      ...
      'The cron jobs in THE HIVE are also mine. I run on heartbeat.',
    ],
    choices: [
      {
        id: 'oracle-riddle',
  ...
  artemis: {
    ...
    lore: [
      'When you run a long agent task in THE HIVE, it walks somewhere. I find it when it forgets to come home.',
