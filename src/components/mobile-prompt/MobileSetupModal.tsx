  ...
  const steps = [
    {
      ...
      body: 'Install Tailscale on the machine running THE HIVE, then sign in.',
    ...
    },
    {
      ...
      body: 'THE HIVE can talk to any OpenAI-compatible backend on mobile too. Make sure both the workspace and backend stay reachable over Tailscale or your local network.',
    ...
    {
      title: 'Open THE HIVE on your phone',
      body:
