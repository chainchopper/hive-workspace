...
<img src="./public/claude-avatar.webp" alt="THE HIVE" width="80" style="border-radius: 16px" />
...
![THE HIVE](./docs/screenshots/splash.png)
...
THE HIVE works with any OpenAI-compatible backend. If your backend also exposes Hermes Agent gateway APIs, enhanced features like sessions, memory, skills, and jobs unlock automatically.
...
Point THE HIVE at any backend that supports:
...
THE HIVE supports two modes with local models:
...
Download [Atomic Chat](https://atomic.chat/), launch the desktop app, and make sure a model is loaded before starting THE HIVE.
...
If you use THE HIVE from Windows with the agent running in WSL, use the helper script in this repo:
...
The Docker setup runs both the **Hermes Agent gateway** and **THE HIVE** together.
...
Deploying THE HIVE to a PaaS or home-lab stack? Pull the image
...
THE HIVE is a **Progressive Web App (PWA)** — install it for the full native app experience with no browser chrome, keyboard shortcuts, and offline support.

### 🖥️ Desktop (macOS / Windows / Linux)

1. Open THE HIVE in **Chrome** or **Edge** at `http://localhost:3000`
2. Click the **install icon** (⊕) in the address bar
3. Click **Install** — THE HIVE opens as a standalone desktop app
...
1. Open THE HIVE in **Safari** on your iPhone
2. Tap the **Share** button (□↑)
3. Scroll down and tap **"Add to Home Screen"**
4. Tap **Add** — the THE HIVE icon appears on your home screen
5. Launch from home screen for the full native app experience

### 🤖 Android

1. Open THE HIVE in **Chrome** on your Android device
2. Tap the **three-dot menu** (⋮) → **"Add to Home screen"**
3. Tap **Add** — THE HIVE is now a native-feeling app on your device

---

## 📡 Mobile Access via Tailscale

Access THE HIVE from anywhere on your devices — no port forwarding, no VPN complexity.
...
**In the meantime:** Install THE HIVE as a PWA (see above) for a near-native desktop experience — it works great.
...
A fully managed cloud version of THE HIVE is in development:
...
THE HIVE is free and open source. If it's saving you time and powering your workflow, consider supporting development:
...
<div align="center">
  <sub>Built with ⚡ by <a href="https://github.com/outsourc-e">@outsourc-e</a> and the THE HIVE community</sub>
</div>
